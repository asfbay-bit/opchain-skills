...
Detailed checks for the `/oc-audit ux` mode. The SKILL.md gives the overview (sweep
1e's severity table); this document provides the automated check commands and the full
